...
// Hero images for About page
import heroAbout1 from "@/assets/Image/GioiThieuPage/Hero1.png";
import heroAbout2 from "@/assets/Image/GioiThieuPage/Hero2.png";
...
export default function About() {
  ...
  // ─── Site config data ─────────────────────────────────────────────────────
  const heroImage = config?.about_hero_image || heroAbout1;
  ...
  // ─── Default narrative ────────────────────────────────────────────────────
  const defaultNarrative = `Công ty trách nhiệm hữu hạn thương mại công nghệ Song Linh (Song Linh Technologies) là công ty chuyên về tư vấn, thiết kế và thi công lắp đặt các hệ thống công nghệ thông tin và hạ tầng kỹ thuật.
...
Chúng tôi cam kết mang đến giải pháp tối ưu nhất cho mỗi dự án — từ khâu tư vấn ban đầu, thiết kế chi tiết, thi công chuyên nghiệp đến bảo trì dài hạn sau bàn giao.`;
  ...
  return (
    <>
      <SEO
        title="Giới thiệu"
        description="Công ty trách nhiệm hữu hạn thương mại công nghệ Song Linh (Song Linh Technologies) — Hơn 10 năm kinh nghiệm trong lĩnh vực tư vấn, thiết kế và thi công hệ thống công nghệ cho doanh nghiệp."
        url="/gioi-thieu"
      />
      ...
      <section className="relative bg-white dark:bg-background">
        <div className="grid min-h-[600px] lg:grid-cols-2">
          ...
          >
            <img
              src={heroImage}
              alt="Công ty trách nhiệm hữu hạn thương mại công nghệ Song Linh — Hệ thống kỹ thuật hạ tầng"
            ...
            >
              <div className="sticky top-32">
                <div className="relative overflow-hidden">
                  <img
                    src={heroAbout2}
                    alt="Công ty Song Linh Technologies — Đội ngũ kỹ thuật"
            ...
            {whyChooseUs.map((item, i) => {
              ...
              return (
                <motion.div
                  ...
                  className="group relative border border-slate-200 bg-white p-8 transition-all duration-300 hover:border-[#3C5DAA]/40 hover:shadow-md dark:border-border dark:bg-card"
                >
                  {/* Icon */}
