...
export default function About() {
  ...
  // ─── Default narrative ────────────────────────────────────────────────────
  const defaultNarrative = `Song Linh Technologies là công ty chuyên về tư vấn, thiết kế và thi công lắp đặt các hệ thống công nghệ thông tin và hạ tầng kỹ thuật.
      ...
      <section className="relative bg-white dark:bg-background">
        <div className="grid min-h-[600px] lg:grid-cols-2">
          ...
          >
            <img
              src={heroImage}
              alt="Song Linh Technologies — Hệ thống kỹ thuật hạ tầng"
            ...
            >
              <div className="sticky top-32">
                <div className="relative overflow-hidden">
                  <img
                    src={heroME}
                    alt="Song Linh Technologies Engineering Team"
